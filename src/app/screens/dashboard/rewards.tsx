  ...
  return (
    <div className="flex flex-col items-center justify-evenly app-bg  rounded-2xl shadow-lg overflow-hidden max-w-6xl w-full p-6 mb-16">
      ...
      <div className="flex flex-col w-full bg-white rounded-2xl p-3">
        <button className="w-full my-4 rounded-2xl app-bg  px-4 py-3 text-sm font-semibold text-white shadow-sm  hover:bg-amber-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
          CLAIM REWARDS
        </button>
